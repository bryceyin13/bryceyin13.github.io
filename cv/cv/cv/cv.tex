...
\educationentry{École polytechnique fédérale de Lausanne (EPFL)}
  ...
  {09/2025 - Present}
\begin{itemize}
  \item Research Focus: Computer Graphics, Computer Vision, and Machine Learning
...
\textit{Research Assistant | {\small Advisor: Prof. Sabine Süsstrunk \externalicon{https://people.epfl.ch/sabine.susstrunk?lang=en} and Dr. Zhuoqian Yang \externalicon{https://inrainbws.github.io/}}}
\begin{itemize}
  \item Working on Weight Space Representation and Implicit Neural Representations.
\end{itemize}
...
\textit{Research Assistant (Remote) | {\small Advisor: Prof. Xiaohu Guo \externalicon{https://personal.utdallas.edu/~xguo/}}}
\begin{itemize}
...
\textit{Research Assistant (Remote) | {\small Advisor: Prof. Toshiya Hachisuka \externalicon{https://cs.uwaterloo.ca/~thachisu/}}}
\begin{itemize}
...
\projectentry{Physically Based Renderer}{2026}
...
\begin{itemize}
  ...
  \item Implemented HDR environment map lighting, thin-lens depth of field, motion blur, principled BSDF, and GGX rough dielectric materials for a storm-scene rendering pipeline.
\end{itemize}
\end{cvsection}
...
\awardentry{\textbf{Lei Jun Computer Innovation and Development Fund}, Wuhan University}{2024}
\end{cvsection}
