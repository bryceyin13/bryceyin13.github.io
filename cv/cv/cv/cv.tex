...
\newcommand{\awardentry}[2]{%
  \item \begin{tabularx}{\linewidth}[t]{@{}Xr@{}}
    #1 & \textit{#2}
  \end{tabularx}%
}
...
\educationentry{École polytechnique fédérale de Lausanne (EPFL)}
  ...
  {M.Sc. in Digital Humanities, School of Computer and Communication Sciences (IC)}
  {09/2025 - Present}
\begin{itemize}
  % \item Research Focus: Computer Graphics and Computer Vision
  \item Coursework: Advanced Computer Graphics (6.0/6.0), Data Visualization (6.0/6.0), Applied Data Analysis (5.5/6.0)
  % \item School of Computer and Communication Sciences (IC)
  \item \textbf{GPA:} 5.59 /6.00
\end{itemize}
...
\textit{CS-440 Advanced Computer Graphics Rendering Competition (6.0/6.0), {\small EPFL}}
\begin{itemize}
...
\vspace{0.58\baselineskip}
% \researchentry{Differentiable Rendering Project}{03/2026 - 06/2026}
% \textit{Realistic Graphics Lab, {\small EPFL}| {\small Mentor: Dr. Ziyi Zhang \externalicon{https://ziyi-zhang.github.io/}}}
% \begin{itemize}
